...
import MessageBubble from './MessageBubble'; // Asegúrate de tener este componente si lo estabas usando
...
export default function ChatArea({
  ...
  return (
    <main className="flex-1 flex flex-col bg-gray-950 h-full w-full relative">
      ...
      {/* EL BOTÓN AHORA ESTÁ FUERA DE LA CONDICIÓN: Siempre se mostrará en móvil */}
      <button
        onClick={() => setSidebarOpen(true)}
        className="md:hidden fixed top-4 left-4 z-50 bg-gray-800 p-2 rounded shadow-lg text-gray-100 hover:bg-gray-700 transition-colors"
      >
        ☰
      </button>
      ...
      {!selectedId ? (
        ...
        <>
          <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-28 pt-16 md:pt-4">
            {loading && (
